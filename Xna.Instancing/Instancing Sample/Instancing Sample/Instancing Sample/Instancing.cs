...
namespace InstancingSample
{
    public class Instancing
    {
        ...
        private void GenerateInstanceVertexDeclaration()
        {
            ...
            instanceStreamElements[1] = new VertexElement(16, VertexElementFormat.Vector2, VertexElementUsage.TextureCoordinate, 1);

            instanceStreamElements[2] = new VertexElement(24 , VertexElementFormat.Color, VertexElementUsage.Color, 1);
        ...
        public void GenerateGeometry(GraphicsDevice device)
        {
            ...
            geometryBuffer = new VertexBuffer(device, VertexPositionColorTexture.VertexDeclaration, 24, BufferUsage.WriteOnly);
        ...
        private void GenerateInstanceInformation(GraphicsDevice device, Int32 count)
        {
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                instances[i].Color = new Color(rnd.Next(255), rnd.Next(255), rnd.Next(255));
            }
        ...
        public void Draw(ref Matrix view, ref Matrix projection, GraphicsDevice device, Int32 time)
        {
            ...
            var rotation = (0.0025f*time)%(float) (Math.PI*2);
           // Console.WriteLine(time);
            effect.Parameters["RotationMat"].SetValue(Matrix.CreateRotationX(rotation));
